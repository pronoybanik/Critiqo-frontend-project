...
import { Check, X, Loader2, CreditCard, Shield, Zap, Clock } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      <div className="text-center mb-16">
        ...
        <p className="mt-4 text-xl text-gray-600 max-w-2xl mx-auto">
          Unlock the full potential of our product review portal with a subscription plan that fits your needs.
        </p>
      </div>
          ...
          <Card key={plan.id} className={`flex flex-col ${plan.popular ? 'border-blue-500 ring-1 ring-blue-500 shadow-lg' : 'border-gray-200'}`}>
            ...
            <CardHeader className={plan.popular ? 'pt-4' : ''}>
              ...
              <div className="mt-4 flex items-baseline text-gray-900">
                ...
                <span className="ml-1 text-lg font-medium text-gray-500">/{plan.interval}</span>
              </div>
              {plan.originalPrice && (
                <div className="mt-1 text-sm text-gray-500">
                  <span className="line-through">${plan.originalPrice}</span>
                  <span className="ml-2 text-green-600">Save ${(plan.originalPrice - plan.price).toFixed(2)}</span>
                </div>
              )}
            </CardHeader>
            <CardContent className="flex-grow">
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium text-gray-900 mb-2">Whats included:</h4>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">All transactions are secured with Stripes industry-leading encryption.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">Flexible subscriptions that can be canceled online at any time.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">Get immediate access to all features after your payment is processed.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <details className="group border-b pb-4">
            ...
            <p className="text-gray-600 mt-3">
              We use Stripe for secure payment processing. Youll be charged at the beginning of each billing period (monthly or yearly). You can cancel anytime from your account dashboard.
            </p>
          </details>
          <details className="group border-b pb-4">
            <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
            ...
            <p className="text-gray-600 mt-3">
              Yes! You can upgrade or downgrade your plan at any time. When upgrading, youll be charged the prorated difference. When downgrading, the new rate will apply at the start of your next billing cycle.
            </p>
          </details>
          <details className="group border-b pb-4">
            <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
            ...
            <p className="text-gray-600 mt-3">
              We accept all major credit cards (Visa, Mastercard, American Express) and some debit cards. In select countries, we also support local payment methods through Stripe.
            </p>
          </details>
          <details className="group border-b pb-4">
            <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
            ...
            <p className="text-gray-600 mt-3">
              We offer limited free access to our basic features. To fully experience the platform, we recommend subscribing to one of our plans, which you can cancel within the first 14 days for a full refund if youre not satisfied.
            </p>
          </details>
        </div>
      </div>
