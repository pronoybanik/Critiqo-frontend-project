        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">All transactions are secured with Stripe's industry-leading encryption.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0">
        ...
        <div className="space-y-4">
          <details className="group border-b pb-4">
            ...
            <p className="text-gray-600 mt-3">
              We use Stripe for secure payment processing. You'll be charged at the beginning of each billing period (monthly or yearly). You can cancel anytime from your account dashboard.
            </p>
          </details>
          <details className="group border-b pb-4">
            <summary className="flex justify-between items-center font-medium cursor-pointer list-none">
          ...
          <details className="group border-b pb-4">
            ...
            <p className="text-gray-600 mt-3">
              We offer limited free access to our basic features. To fully experience the platform, we recommend subscribing to one of our plans, which you can cancel within the first 14 days for a full refund if you're not satisfied.
            </p>
          </details>
        </div>
      </div>
