...
const sampleBlogs: Blog[] = [
  ...
  },
  {
    ...
    author: "Morgan Chen",
    date: "April 28, 2025",
    image: "https://img.freepik.com/free-photo/historical-sinaia-monastery-surrounded-by-green-trees-sinaia-romania_181624-17259.jpg?t=st=1746597527~exp=1746601127~hmac=9b328f7de7b1d40ce2c3a1f54b517a6e2d5150d579c6823fad238f3ea16754cb&w=996",
    likes: 29,
    category: "Technology",
    readTime: "6 min",
    tags: ["VR", "tourism", "technology", "travel"],
    comments: [
      { id: 1, author: "Robin T.", date: "April 29, 2025", text: "I tried a VR tour of the Louvre last month and was blown away by how detailed it was!" },
      { id: 2, author: "Casey B.", date: "May 2, 2025", text: "Interesting concept, but I still prefer real travel. Nothing beats the real thing." }
    ]
  },
  {
    id: 4,
    title: "Sustainable Home Renovation Tips",
    excerpt: "Transform your living space with these eco-friendly renovation ideas that are both beautiful and planet-conscious.",
    content: "Home renovations provide the perfect opportunity to make your living space more sustainable. By choosing eco-friendly materials and energy-efficient systems, you can reduce your environmental footprint while creating a healthier home environment.\n\nStart with energy efficiency. Upgrading insulation, sealing air leaks, and installing energy-efficient windows can dramatically reduce your energy consumption. Consider appliances with high energy-star ratings and LED lighting throughout your home.\n\nWhen it comes to materials, look for recycled, reclaimed, or sustainably sourced options. Bamboo flooring, recycled glass countertops, and reclaimed wood features add character while minimizing environmental impact. Low-VOC paints and natural finishes improve indoor air quality.\n\nWater conservation should be a priority with low-flow fixtures, dual-flush toilets, and perhaps a rainwater harvesting system for garden irrigation. For larger renovations, consider solar panels or other renewable energy systems.\n\nRemember that the most sustainable approach often involves working with what you already have. Refinishing existing floors or cabinets rather than replacing them reduces waste and often costs less. With thoughtful planning, your renovation can be beautiful, functional, and environmentally responsible.",
    author: "Taylor Green",
    date: "May 5, 2025",
    image: "https://img.freepik.com/free-vector/household-appliances-realistic-composition_1284-65307.jpg?t=st=1746597460~exp=1746601060~hmac=0b039a46c934996922027d769755b32bc24eb8d613df8ba6076561b5621ceed2&w=1060",
    likes: 18,
    category: "Home & Garden",
    readTime: "7 min",
    tags: ["sustainability", "home renovation", "eco-friendly", "DIY"],
    comments: [
      { id: 1, author: "Pat J.", date: "May 6, 2025", text: "We just finished a kitchen renovation using recycled materials and it turned out amazing!" }
    ]
  },
  {
    id: 5,
  ...
  },
  {
    ...
    author: "Taylor Green",
    date: "May 5, 2025",
    image: "https://img.freepik.com/free-photo/standard-quality-control-concept-m_23-2150041859.jpg?t=st=1746597404~exp=1746601004~hmac=f644644f18a81e0f88aaae3d426a7eda7c769ef495b427bef4488cefc9e45f46&w=900",
    likes: 18,
    category: "Technology",
    readTime: "7 min",
    tags: ["sustainability", "home renovation", "eco-friendly", "DIY"],
...
const BlogPage: React.FC = () => {
  ...
  const addComment = (e?: React.MouseEvent): void => {
    ...
    const updatedSelectedBlog = updatedBlogs.find(blog => blog.id === selectedBlog.id);
  ...
  return (
    <div className={`max-w-6xl mx-auto px-4 py-8 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-800'}`}>
      {/* Header with Dark Mode Toggle */}
      <div className="flex justify-between items-center mb-8">
        <h1 className={`text-4xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'}`}>Our Blog</h1>
        <button
      ...
      {selectedBlog ? (
        ...
        <div className="animate-fade-in">
          ...
          <button
            ...
            className={`flex items-center ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-800'} mb-6 transition duration-200`}
          >
          ...
          <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden mb-8`}>
            ...
            <div className="p-6">
              ...
              <h2 className={`text-3xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'} mb-4`}>{selectedBlog.title}</h2>

              <div className={`flex items-center ${darkMode ? 'text-gray-400' : 'text-gray-600'} mb-6`}>
              ...
              <div className={`${darkMode ? 'text-gray-300' : 'text-gray-800'} mb-6 whitespace-pre-line`}>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {selectedBlog.tags.map((tag, index) => (
                  <span
                    key={index}
                    className={`px-3 py-1 rounded-full text-xs font-medium ${darkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-200 text-gray-700'}`}
                  >
                    #{tag}
                  </span>
                ))}
              ...
              <div className={`border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'} pt-4 flex items-center justify-between`}>
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={likeBlog}
                    className={`flex items-center ${darkMode ? 'text-rose-400 hover:text-rose-300' : 'text-rose-500 hover:text-rose-700'} transition duration-200`}
                  >
                    <Heart className="w-5 h-5 mr-1" fill={selectedBlog.likes > 0 ? 'currentColor' : 'none'} />
                    <span>{selectedBlog.likes}</span>
                  </button>

                  <button
                    onClick={(e) => toggleBookmark(selectedBlog.id, e)}
                    className={`ml-4 ${darkMode ? 'text-yellow-400 hover:text-yellow-300' : 'text-yellow-500 hover:text-yellow-700'}`}
                  >
          ...
          <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden mb-8`}>
            <div className="p-6">
              <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'} mb-6`}>You might also like</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {blogs
                  .filter(blog => blog.id !== selectedBlog.id && blog.category === selectedBlog.category)
                  .slice(0, 2)
                  .map(blog => (
                    <div
                      key={blog.id}
                      className={`flex gap-4 cursor-pointer ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} p-2 rounded transition duration-200`}
                    ...
                    >
                      ...
                      />
                      <div>
                        <h4 className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'} mb-1`}>{blog.title}</h4>
                        <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{blog.readTime} read</p>
                      </div>
                    </div>
                  ))}
              </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-6 mb-8">
                {selectedBlog.comments.map(comment => (
                  <div key={comment.id} className={`border-b ${darkMode ? 'border-gray-700' : 'border-gray-100'} pb-6 last:border-b-0 last:pb-0`}>
                    <div className="flex justify-between mb-2">
                      <span className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>{comment.author}</span>
              ...
              {/* Add Comment Section */}
              <div className="mt-8">
                <h4 className={`text-lg font-medium ${darkMode ? 'text-white' : 'text-gray-800'} mb-4`}>Leave a comment</h4>
                <div className="relative">
                  <textarea
                    value={newComment}
                    onChange={(e) => setNewComment(e.target.value)}
                    placeholder="Share your thoughts..."
                    className={`w-full p-4 pr-12 border rounded-lg resize-none ${darkMode
                  ...
                  <button
                    onClick={addComment}
                    className={`absolute right-3 bottom-3 p-2 rounded-full ${darkMode
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            {/* Categories */}
            <div className="mt-4">
              <h3 className={`text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-2`}>Categories</h3>
              <div className="flex flex-wrap gap-2">
                ...
                {categories.map((category, index) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${activeCategory === category
                      ? (darkMode ? 'bg-blue-700 text-white' : 'bg-blue-600 text-white')
                      : (darkMode ? 'bg-gray-700 text-gray-300 hover:bg-gray-600' : 'bg-gray-200 text-gray-700 hover:bg-gray-300')
                      }`}
                  >
            ...
            {/* Tags */}
            <div className="mt-4">
              <h3 className={`text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-2`}>Popular Tags</h3>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredBlogs.map(blog => (
              <div
                key={blog.id}
                className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300 cursor-pointer`}
                onClick={() => viewBlogDetails(blog.id)}
              >
                <Image
                  src={blog.image}
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${darkMode ? 'bg-blue-900 text-blue-200' : 'bg-blue-100 text-blue-800'}`}>
                      {blog.category}
                    </span>
                    <button
                  ...
                  <h2 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'} mb-2`}>{blog.title}</h2>
                  <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} mb-4 line-clamp-3`}>{blog.excerpt}</p>
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center">
                      <span className={`${darkMode ? 'text-gray-500' : 'text-gray-500'} mr-3`}>{blog.readTime} read</span>
                      <div className="flex items-center text-rose-500">
                        <Heart className="w-4 h-4 mr-1" fill={blog.likes > 0 ? 'currentColor' : 'none'} />
