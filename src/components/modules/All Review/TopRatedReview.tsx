...
const TopRatedReview = (featured: any) => {
  console.log("39", featured)
  return (
    <div className="py-8">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-semibold text-gray-950 mb-6">Top Rated Review</h2>
            ...
            <Card key={review.id} className="bg-white border-gray-200 shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardContent className='flex justify-between items-center'>
                ...
                <div className='flex gap-2 items-center'>
                  ...
                  <span className="text-gray-500 text-sm">({review?.rating} ) out of 5</span>
                </div>
              </CardContent>
            </Card>
          ))}
