        ...
        <Card className="bg-gray-50 border-gray-800 shadow-lg">
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                <CardTitle className="text-2xl font-bold text-gray-950">
              ...
              <Badge
                variant={getStatusBadgeVariant(reviewDetails?.review?.status)}
              >
                {getStatusBadgeText(reviewDetails?.review?.status)}
              </Badge>
            </div>
            ...
            <div className="grid grid-cols-3 ">
              ...
              <div className="shadow-xl bg-gray-100 col-span-1 rounded-xl">
                <VoteCounter
                  initialVotes={reviewDetails?.review?.votes.upvotes}
